(() => {
    ...
    },
    {
      ...
      objs: {
        ...
        canvas: document.querySelector(
          "#scroll-section-11 .image-blend-canvas"
        ),
        ...
        context: document
          .querySelector("#scroll-section-11 .image-blend-canvas")
          .getContext("2d"),
        imagesPath: 6,
        images: [],
      },
  ...
  function setLayout() {
    ...
    sceneInfo[10].objs.context4.drawImage(
      sceneInfo[10].objs.images[0],
      0,
      0,
      sceneInfo[10].objs.images[0].naturalWidth,
      sceneInfo[10].objs.images[0].naturalHeight,
      sceneInfo[10].objs.canvas4.width * 0.35,
      sceneInfo[10].objs.canvas4.height * 0.4,
      sceneInfo[10].objs.images[0].naturalWidth * canvasScaleRatio3 * 0.6,
      sceneInfo[10].objs.images[0].naturalHeight * canvasScaleRatio3 * 0.6
    );

    sceneInfo[10].objs.canvas5.style.transform = `translate3d(-50%,-50%,0)`;
    sceneInfo[10].objs.context5.drawImage(
      sceneInfo[10].objs.images[1],
      0,
      0,
      sceneInfo[10].objs.images[0].naturalWidth,
      sceneInfo[10].objs.images[0].naturalHeight,
      sceneInfo[10].objs.canvas5.width * 0.35,
      sceneInfo[10].objs.canvas5.height * 0.4,
      sceneInfo[10].objs.images[0].naturalWidth * canvasScaleRatio3 * 0.6,
      sceneInfo[10].objs.images[0].naturalHeight * canvasScaleRatio3 * 0.6
    );

    sceneInfo[10].objs.canvas6.style.transform = `translate3d(-50%,-50%,0)`;
    sceneInfo[10].objs.context6.drawImage(
      sceneInfo[10].objs.images[2],
      0,
      0,
      sceneInfo[10].objs.images[0].naturalWidth,
      sceneInfo[10].objs.images[0].naturalHeight,
      sceneInfo[10].objs.canvas6.width * 0.35,
      sceneInfo[10].objs.canvas6.height * 0.4,
      sceneInfo[10].objs.images[0].naturalWidth * canvasScaleRatio3 * 0.6,
      sceneInfo[10].objs.images[0].naturalHeight * canvasScaleRatio3 * 0.6
    );
  }
  ...
  function playAnimation() {
    ...
    switch (currentScene) {
      case 0:
        if (scrollRatio <= 0.4) {
          objs.headmessage.style.fontSize = `${calcValues(
            values.headmessage_fontsize_out,
            currentYOffset
          )}rem`;
          objs.headmessage.style.opacity = calcValues(
            values.headmessage_opacity_out,
            currentYOffset
          );
        }
        break;
      ...
      case 2:
        ...
        if (scrollRatio < values.rect1X[2].end) {
          ...
          if (
            scrollRatio >= values.blendHeight2[2].end &&
      ...
      case 4:
        ...
        if (scrollRatio <= 0.67) {
          ...
          objs.messageD.style.fontSize = `${calcValues(
            values.messageD_fontsize_up,
            currentYOffset
          )}rem`;
        } else {
          // out
      ...
      case 7:
        ...
        if (scrollRatio <= 0.15) {
          ...
          objs.messageA.style.fontSize = `${calcValues(
            values.messageA_fontsize_in,
            currentYOffset
          )}rem`;
        } else {
          // out
        ...
        if (scrollRatio <= 0.3) {
          ...
          objs.messageB.style.fontSize = `${calcValues(
            values.messageB_fontsize_in,
            currentYOffset
          )}rem`;
        } else {
          // out
        ...
        if (scrollRatio <= 0.45) {
          ...
          objs.messageC.style.fontSize = `${calcValues(
            values.messageC_fontsize_in,
            currentYOffset
          )}rem`;
        } else {
          // out
        ...
        if (scrollRatio <= 0.6) {
          ...
          objs.messageD.style.fontSize = `${calcValues(
            values.messageD_fontsize_out,
            currentYOffset
          )}rem`;
        }
        if (scrollRatio <= 0.75) {
          // in
          objs.messageE.style.opacity = calcValues(
          ...
          objs.messageE.style.fontSize = `${calcValues(
            values.messageE_fontsize_in,
            currentYOffset
          )}rem`;
        } else {
          // out
      ...
      case 9:
        ...
        if (scrollRatio <= 0.35) {
          ...
          objs.canvas1.style.opacity = calcValues(
            values.canvas1_opacity_in,
            currentYOffset
          );
          objs.canvas1.style.transform = `translate3d(-50%, ${
            calcValues(values.canvas1_translateY_in, currentYOffset) - 55
          }%, 0) 
					scale(${
            kcanvasScaleRatio * 0.5 +
            calcValues(values.canvas1_scale_in, currentYOffset)
          })`;
        } else {
          // out
          objs.messageA.style.opacity = calcValues(
          ...
          objs.canvas1.style.opacity = calcValues(
            values.canvas1_opacity_out,
            currentYOffset
          );
          objs.canvas1.style.transform = `translate3d(-50%, ${
            calcValues(values.canvas1_translateY_out, currentYOffset) - 55
          }%, 0) scale(${kcanvasScaleRatio * 0.5})`;
        }
        ...
        if (scrollRatio <= 0.6) {
          ...
          objs.canvas2.style.opacity = calcValues(
            values.canvas2_opacity_in,
            currentYOffset
          );
          objs.canvas2.style.transform = `translate3d(-39%, ${
            calcValues(values.canvas2_translateY_in, currentYOffset) - 50
          }%, 0) scale(${
            kcanvasScaleRatio * 0.5 +
            calcValues(values.canvas2_scale_in, currentYOffset)
          })`;
        } else {
          // out
          objs.messageB.style.transform = `translate3d(0, ${calcValues(
          ...
          objs.canvas2.style.transform = `translate3d(-39%, ${
            calcValues(values.canvas2_translateY_out, currentYOffset) - 50
          }%, 0) scale(${kcanvasScaleRatio * 0.5})`;
        }
        ...
        if (scrollRatio <= 0.8) {
          ...
          objs.canvas3.style.opacity = calcValues(
            values.canvas3_opacity_in,
            currentYOffset
          );
          objs.canvas3.style.transform = `translate3d(-46%, ${
            calcValues(values.canvas3_translateY_in, currentYOffset) - 50
          }%, 0) scale(${
            kcanvasScaleRatio * 0.5 +
            calcValues(values.canvas3_scale_in, currentYOffset)
          })`;
        } else {
          // out
          objs.messageC.style.transform = `translate3d(0, ${calcValues(
          ...
          objs.canvas3.style.opacity = calcValues(
            values.canvas3_opacity_out,
            currentYOffset
          );
          objs.canvas3.style.transform = `translate3d(-46%, ${
            calcValues(values.canvas3_translateY_out, currentYOffset) - 50
          }%, 0) scale(${kcanvasScaleRatio * 0.5})`;
      ...
      case 10:
        ...
        if (scrollRatio <= 0.22) {
          ...
          objs.canvas4.style.opacity = calcValues(
            values.canvas4_opacity_in,
            currentYOffset
          );
        } else {
          // out
        ...
        if (scrollRatio <= 0.42) {
          ...
          objs.canvas5.style.opacity = calcValues(
            values.canvas5_opacity_in,
            currentYOffset
          );
        } else {
          // out
        ...
        if (scrollRatio <= 0.62) {
          ...
          objs.canvas6.style.opacity = calcValues(
            values.canvas6_opacity_in,
            currentYOffset
          );
        } else {
          // out
      ...
      case 11:
        ...
        if (!values.rectStartY) {
          values.rectStartY =
            objs.canvas.offsetTop +
            (objs.canvas.height - objs.canvas.height * canvasScaleRatio4) / 2;
          ...
          values.msgA_opacity_out[2].end =
            values.msgA_trans_out[2].start + 0.05;
        ...
        if (scrollRatio <= values.phoneAni[2].start) {
          ...
          if (
            scrollRatio >= values.phoneAni[2].end &&
            values.phoneAni[2].end > 0
          ) {
            objs.canvas.classList.remove("sticky");
        ...
        if (
          scrollRatio >= values.canvasCaption_translateY[2].start &&
          values.canvasCaption_translateY[2].start > 0
        ) {
        ...
        if (scrollRatio <= values.msgA_opacity_in[2].end) {
          objs.msgA.style.opacity = calcValues(
            values.msgA_opacity_in,
            currentYOffset
          );
          objs.msgA.style.transform = `translate3d(0, ${calcValues(
            values.msgA_trans_in,
            currentYOffset
          )}%, 0)`;
        } else {
          objs.msgA.style.opacity = calcValues(
          ...
          objs.msgA.style.transform = `translate3d(0, ${calcValues(
            values.msgA_trans_out,
            currentYOffset
          )}%, 0)`;
        }

        if (scrollRatio <= values.msgB_opacity_in[2].end) {
          objs.msgB.style.opacity = calcValues(
            values.msgB_opacity_in,
            currentYOffset
          );
          objs.msgB.style.transform = `translate3d(0, ${calcValues(
            values.msgB_trans_in,
            currentYOffset
          )}%, 0)`;
        } else {
          objs.msgB.style.opacity = calcValues(
          ...
          objs.msgB.style.transform = `translate3d(0, ${calcValues(
            values.msgB_trans_out,
            currentYOffset
          )}%, 0)`;
        }

        if (scrollRatio <= values.msgC_opacity_in[2].end) {
          objs.msgC.style.opacity = calcValues(
            values.msgC_opacity_in,
            currentYOffset
          );
          objs.msgC.style.transform = `translate3d(0, ${calcValues(
            values.msgC_trans_in,
            currentYOffset
          )}%, 0)`;
        } else {
          objs.msgC.style.opacity = calcValues(
          ...
          objs.msgC.style.transform = `translate3d(0, ${calcValues(
            values.msgC_trans_out,
            currentYOffset
          )}%, 0)`;
        }

        if (scrollRatio <= values.msgD_opacity_in[2].end) {
          objs.msgD.style.opacity = calcValues(
            values.msgD_opacity_in,
            currentYOffset
          );
          objs.msgD.style.transform = `translate3d(0, ${calcValues(
            values.msgD_trans_in,
            currentYOffset
          )}%, 0)`;
        } else {
          objs.msgD.style.opacity = calcValues(
          ...
          objs.msgD.style.transform = `translate3d(0, ${calcValues(
            values.msgD_trans_out,
            currentYOffset
          )}%, 0)`;
        }

        if (
          scrollRatio > values.msgA_opacity_in[2].start &&
          scrollRatio <= values.msgA_opacity_out[2].end
        ) {
          objs.context.drawImage(
            objs.images[1],
            0,
            ...
            objs.images[0].naturalHeight,
            objs.canvas.width * 0.55,
            (objs.canvas.height -
              objs.images[0].naturalHeight * canvasScaleRatio4) /
              2,
            objs.images[0].naturalWidth * canvasScaleRatio4,
            objs.images[0].naturalHeight * canvasScaleRatio4
          );
        } else if (
          scrollRatio > values.msgB_opacity_in[2].start &&
          scrollRatio <= values.msgB_opacity_out[2].end
        ) {
          objs.context.drawImage(
            objs.images[2],
            0,
          ...
          scrollRatio > values.msgC_opacity_in[2].start &&
          scrollRatio <= values.msgC_opacity_out[2].end
        ) {
          objs.context.drawImage(
            objs.images[3],
            0,
          ...
          scrollRatio > values.msgD_opacity_in[2].start &&
          scrollRatio <= values.msgD_opacity_out[2].end
        ) {
          objs.context.drawImage(
            objs.images[4],
            0,
      ...
      case 13:
        ...
        if (scrollRatio >= 0.8) {
          objs.pencilLogo.style.transform = `translate(50%,-${calcValues(
            values.pencilLogo_translateX_out2,
            currentYOffset
          )}%)`;
        }
      ...
      case 14:
        document.body.style.background = "white";
        if (scrollRatio <= 0.2) {
          objs.messageMain.style.opacity = calcValues(
            values.messageMain_opacity_in,
            currentYOffset
          );
          objs.messageMain.style.transform = `translate3d(0, ${calcValues(
            values.messageMain_tran_in,
            currentYOffset
          )}%,0)`;
          ...
          objs.messageMain.style.opacity = calcValues(
            values.messageMain_opacity_out,
            currentYOffset
          );
          objs.messageMain.style.transform = `translate3d(0, ${calcValues(
            values.messageMain_tran_out,
            currentYOffset
          )}%,0)`;
          if (parseInt(scrollRatio) % 2 === 0) {
            if (scrollRatio <= 0.3) {
              ...
              objs.char5.innerHTML = String.fromCharCode(
                parseInt(calcValues(values.char_uni_5, currentYOffset))
              );
              if (scrollRatio >= 0.5) {
                objs.char5.innerHTML = "우";
              }
            ...
            if (scrollRatio <= 0.35) {
              ...
              objs.char6.innerHTML = String.fromCharCode(
                parseInt(calcValues(values.char_uni_6, currentYOffset))
              );
              if (scrollRatio >= 0.52) {
                objs.char6.innerHTML = "리";
              }
            ...
            if (scrollRatio <= 0.4) {
              ...
              objs.char7.innerHTML = String.fromCharCode(
                parseInt(calcValues(values.char_uni_7, currentYOffset))
              );
              if (scrollRatio >= 0.54) {
                objs.char7.innerHTML = "가";
              }
            ...
            if (scrollRatio <= 0.4) {
              ...
              objs.char1.innerHTML = String.fromCharCode(
                parseInt(calcValues(values.char_uni_1, currentYOffset))
              );
              if (scrollRatio >= 0.56) {
                objs.char1.innerHTML = "지";
              }
            ...
            if (scrollRatio <= 0.45) {
              ...
              objs.char2.innerHTML = String.fromCharCode(
                parseInt(calcValues(values.char_uni_2, currentYOffset))
              );
              if (scrollRatio >= 0.57) {
                objs.char2.innerHTML = "켜";
              }
            ...
            if (scrollRatio <= 0.5) {
              ...
              objs.char3.innerHTML = String.fromCharCode(
                parseInt(calcValues(values.char_uni_3, currentYOffset))
              );
              if (scrollRatio >= 0.59) {
                objs.char3.innerHTML = "줄";
              }
            ...
            if (scrollRatio <= 0.55) {
              ...
              objs.char4.innerHTML = String.fromCharCode(
                parseInt(calcValues(values.char_uni_4, currentYOffset))
              );
              if (scrollRatio >= 0.6) {
                objs.char4.innerHTML = "게";
              }
  ...
  function loop() {
    ...
    if (delayedYOffset < 1) {
      ...
      sceneInfo[5].objs.context.drawImage(
        sceneInfo[5].objs.videoImages[0],
        0,
        0
      );
    }
